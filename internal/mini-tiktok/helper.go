...
const (
	// recommendedHomeDir 定义放置 mini-tiktok 服务配置的默认目录.
	recommendedHomeDir = ".mini-tiktok"

	// defaultConfigName 指定了 mini-tiktok 服务的默认配置文件名.
	defaultConfigName = "mini-tiktok.yaml"
)
...
func initConfig() {
	...
	// 读取环境变量的前缀为 MINI-TIKTOK，如果是 mini-tiktok，将自动转变为大写。
	viper.SetEnvPrefix("MINI-TIKTOK")
